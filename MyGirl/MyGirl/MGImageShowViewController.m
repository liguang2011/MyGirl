...
@interface MGImageShowViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,CardLayoutDelegate>
...
@implementation MGImageShowViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.view.backgroundColor = RGBColorC(0x2D3142);
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UIImage * image= [UIImage imageNamed:[NSString stringWithFormat:@"family%zi.jpg",indexPath.row]];
    if (!image) {
        image= [UIImage imageNamed:[NSString stringWithFormat:@"family%zi.JPG",indexPath.row]];
    }
    cell.image = image;
